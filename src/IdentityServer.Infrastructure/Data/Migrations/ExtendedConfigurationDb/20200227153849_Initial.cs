        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtendedClientId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clients_ExtendedClient_ExtendedClientId",
                        column: x => x.ExtendedClientId,
                        principalTable: "ExtendedClient",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_ExtendedClientId",
                table: "Clients",
                column: "ExtendedClientId");
